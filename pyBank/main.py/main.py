...
#create path
#Relative Path
# RUTJER201809DATA3\03-Python\Homework\Instructions\PyBank\Resources\budget_data.csv
#Absolute Path
# C:\Users\Ike\Desktop\RUTJER201809DATA3\03-Python\Homework\Instructions\PyBank\Resources\budget_data.csv
budget_csvpath = os.path.join('RUTJER201809DATA3//03-Python//Homework//Instructions//PyBank//Resources//budget_data.csv')
#print(budget_csvpath)
#read csv file
with open(budget_csvpath, newline='', encoding='utf-8') as budget_csv:
    budget_csvreader = csv.reader(budget_csv, delimiter=',')
